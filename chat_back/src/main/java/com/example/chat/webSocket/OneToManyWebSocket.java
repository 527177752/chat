 ...
 */
@Slf4j
@ServerEndpoint(value = "/test/oneToMany/{sendId}/{recId}")
@Component
public class OneToManyWebSocket {
    ...
    public void setUserService(IUserService userService) {
        OneToManyWebSocket.userService = userService;
    }
     ...
     */
    @OnOpen
    public void onOpen(@PathParam("sendId") String sendId,@PathParam("recId") String recId, Session session) {
